        ...
        <div class="navbar-nav w-50 align-items-center justify-content-center">
            ...
            <a href="{{ url('/contact') }}" class="nav-item nav-link">Contact</a>
                ...
                <div class="position-absolute end-0 px-5">
                    ...
                    <button type="button" class=" btn btn-transparent nav-item nav-link" data-bs-toggle="modal" data-bs-target="#loginModal" >
                        {{ __('Login') }}
                    </button>
                    <button type="button" class="btn btn-transparent nav-item nav-link" data-bs-toggle="modal" data-bs-target="#registerModal">
                        {{ __('Register') }}
                    </button>
